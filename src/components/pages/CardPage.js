...
//                             </thead>
//                             <tbody>
//                                 {/* loop throught cart products */}
//                                 {cart.map((item) => (
//                                     <tr>
//                                         <td>&nbsp;</td>
//                                         <td>
//                                             <i className="fa fa-times" style={{marginRight: 10, cursor:'pointer'}}></i>
//                                             <img src={item.pictures[0].url} style={{ width: 100, height: 100, objectFit:"cover"}} alt="img"/>
//                                         </td>
//                                         <td>${item.price}</td>
//                                         <td>
...
const stripePromise = loadStripe("pk_test_51LbloJJ3sC1XL08FfljWZb8xmXRwrJir3jOLje1MVirGEyPyi8Dtr2eHjOwMqr5obIa9PxU2obOjcWKfP2Gw6ANX00ZgdGs2XP");
